  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-center">
      {allRecipes?.map((item) => (
        <div
  key={item._id}
  className="bg-gradient-to-br from-white via-orange-50 to-yellow-50 border border-orange-200 rounded-2xl shadow-lg p-5 w-full max-w-xs cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105"
